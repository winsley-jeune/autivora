...
const dossier = { alibabaId:"1", sku:"AB-1", hypothesisId:"h", supplier:{ name:"Supplier", url:"https://www.alibaba.com/product-detail/x_1.html", images:["https://example.com/a.jpg"], evidence:{ verifiedAt:"2026-09-05T00:00:00Z", testQuantity:2, deliveryMinDays:8, deliveryMaxDays:9 } }, marketEvidence:{verifiedAt:"2026-09-05T00:00:00Z",intent:"transactional",monthlySearchVolume:100,shoppingComparables:10}, collection:{handle:"smart-home-atmosphere"}, offer:{title:"Aura",bodyHtml:"<p>Ships in 9 days.</p>",seoTitle:"Aura | Autivara",seoDescription:"A grounded product offer.",productType:"Diffuser"}, economics:{sellingPrice:69.99,supplierCost:17,shippingCost:8,landedCost:25,fulfillmentCost:6,expectedRefundRate:.08} };
