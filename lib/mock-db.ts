...
export const LUXURY_BRANDS: Record<string, Record<string, VehicleData>> = {
      ...
      faq: [
        {
          ...
          answer:
            "For the Panamera Executive with its 3,100mm wheelbase, one unit at intensity 4-5 covers the full cabin. For dedicated rear-seat fragrance, consider a second unit in the rear armrest.",
        },
        {
          question: "How does the 48-hour battery handle long road trips?",
          answer:
            "At intensity level 4, the battery runs for approximately 36 hours. That\u2019s over a week of 4-hour drives. USB-C charging means you can top up from the Panamera\u2019s console ports.",
        },
      ],
    ...
    "amg-gt": {
      ...
      faq: [
        ...
        },
        {
          ...
          answer:
            "The aluminum body actually dissipates heat well. The sealed oil reservoir prevents evaporation up to 60\u00B0C. No leaking, no warping, no degradation.",
        },
      ],
  ...
  bmw: {
    ...
    x5: {
      ...
      faq: [
        ...
        },
        {
          ...
          answer:
            "The anodized aluminum body wipes clean with a damp microfiber cloth. The nebulizer element can be flushed with isopropyl alcohol every 6 months. No filters to replace.",
        },
      ],
    ...
    "4-series": {
      ...
      placement:
        "Center console cup holder. The 4 Series shares its console architecture with the 3 Series \u2014 same 74mm cup holders, same stable platform.",
      cabin_size: "medium",
      intensity_rec: 3,
      interior_notes:
      ...
      faq: [
        {
          ...
          answer:
            "At intensity 3, the 48-hour battery covers approximately 4.8 days of 2-hour commutes (round trip). A Friday overnight charge keeps you running all week.",
        },
        {
          question: "The Sportback has a large glass roof \u2014 does heat affect performance?",
          answer:
            "Direct sunlight on the aluminum body is fine \u2014 the unit dissipates heat naturally. The sealed oil reservoir prevents evaporation. Tested up to 60\u00B0C ambient.",
        },
      ],
    ...
    "continental-gt": {
      ...
      faq: [
        ...
        },
        {
          ...
          answer:
            "At intensity 3, the battery runs about 42 hours \u2014 covering a London-to-Monaco drive three times over without charging. USB-C top-up takes 2 hours.",
        },
      ],
